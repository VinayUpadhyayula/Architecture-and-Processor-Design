...
APEX_decode(APEX_CPU *cpu)
{
    if (cpu->decode.has_insn)
    {
        ...
        case OPCODE_STORE:
        {
            if (((!cpu->dirty && !cpu->execute.has_insn) && !cpu->memory.has_insn) || cpu->no_forward)
            {
                cpu->decode.rs1_value = cpu->regs[cpu->decode.rs1];

                cpu->decode.rs2_value = cpu->regs[cpu->decode.rs2];
            }
            cpu->stall = check_for_LOADP_STOREP_stall(cpu); 
...
int check_for_LOADP_STOREP_stall(APEX_CPU *cpu)
{
    if (!cpu->dirty)
    {
        if (cpu->execute.opcode == OPCODE_LOADP)
        {
            if (cpu->decode.rs1 == cpu->execute.rd || cpu->decode.rs1 == cpu->execute.rs1)
                return TRUE;
            else if (check_rs2(cpu->decode.opcode))
            {
                if (cpu->decode.rs2 == cpu->execute.rd || cpu->decode.rs2 == cpu->execute.rs1)
                    return TRUE;
            }
        }
        else if (cpu->execute.opcode == OPCODE_STOREP)
        {
            if (cpu->decode.rs1 == cpu->execute.rs2)
                return TRUE;
            else if (check_rs2(cpu->decode.opcode))
            {
                if (cpu->decode.rs2 == cpu->execute.rs2)
                    return TRUE;
            }
        }
    }
...
void data_forwarding(APEX_CPU *cpu)
{
    ...
    case OPCODE_XOR:
    {
        if (cpu->visited)
        {
            if ((cpu->execute.has_insn && check_forwarding_eligible(cpu->execute.opcode)) && (cpu->execute.rd == cpu->decode.rs1) && (cpu->execute.opcode != OPCODE_LOADP) && (cpu->execute.opcode != OPCODE_STOREP))
            {
            ...
            if ((cpu->execute.has_insn && check_forwarding_eligible(cpu->execute.opcode)) && (cpu->execute.rd == cpu->decode.rs2) && (cpu->execute.opcode != OPCODE_LOADP) && (cpu->execute.opcode != OPCODE_STOREP))
            {
    ...
    case OPCODE_JALR:
    {
        if (cpu->visited)
        {
            if ((cpu->execute.has_insn && check_forwarding_eligible(cpu->execute.opcode)) && (cpu->execute.rd == cpu->decode.rs1))
            {
                cpu->decode.rs1_value = cpu->execute.result_buffer;
                cpu->rs1_updated = TRUE;
            }
...
void check_forwarding_for_LOADP_and_STOREP(APEX_CPU *cpu)
{
    ...
    case OPCODE_LOADP:
    {
        ...
        if (check_rs2(cpu->decode.opcode) && cpu->execute.rs1 == cpu->decode.rs2)
        {
        ...
        {
            cpu->decode.rs1_value = cpu->data_memory[cpu->execute.memory_address];
            break;
        }
        if (check_rs2(cpu->decode.opcode) && cpu->execute.rd == cpu->decode.rs2)
        {
            cpu->decode.rs2_value = cpu->data_memory[cpu->execute.memory_address];
            break;
        }
        break;
    }
    case OPCODE_STOREP:
    {
        ...
        if (check_rs2(cpu->decode.opcode) && cpu->execute.rs2 == cpu->decode.rs2)
        {
    ...
    case OPCODE_LOADP:
    {
        ...
        if ((check_rs2(cpu->decode.opcode) && cpu->memory.rs1 == cpu->decode.rs2) && !cpu->rs2_updated)
        {
    ...
    case OPCODE_STOREP:
    {
        ...
        if ((check_rs2(cpu->decode.opcode) && cpu->memory.rs2 == cpu->decode.rs2) && !cpu->rs2_updated)
        {
